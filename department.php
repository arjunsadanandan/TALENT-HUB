...
if (isset($_POST['submit'])){
    ...
    mysqli_query($con,"insert into department(department_name,college_id)values('$departmentname','$college')");
}
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block">   <img src="<?php echo data_uri ('d:\xampp\htdocs\task\images\Screenshot (4).png','image/png'); ?>" height="317px" width="470px" alt="An imag"/></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                        ...
                        while($data=mysqli_fetch_assoc($sql)){
                            ?>
                            <option value="<?php echo$data['college_id']?>"><?php echo$data['college_name']?></option>
                            <?php
                        }
                        ?>
                     </select>
